...
Incluye registro/login, cinco entidades, once endpoints, DTO, validación, errores, JWT, MySQL y Swagger. Quedan fuera historia clínica, facturación, inventario, recordatorios, frontend y despliegue cloud. Docker no aporta puntaje al taller. Por solicitud del estudiante, se usa para alojar únicamente MySQL; la API sigue ejecutándose con Java 17.
...
[Conexión desde Workbench y manejo del contenedor](docs/mysql-docker.md).
